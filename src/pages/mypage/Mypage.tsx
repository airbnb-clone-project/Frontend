  ...
  return (
    <main className="flex">
      ...
      <section className="w-[100%] pt-[30px] flex flex-col  items-center">
        ...
        >
          <span className="text-[40px] text-[#211922] font-semibold">T</span>
        </div>
        ...
        <div className="flex items-center">
          ...
          <span className="text-[14px] text-[#767676]">taewok5163</span>
        </div>
        ...
        >
          <div
            className={`active:scale-95 rounded-[8px] px-[8px] py-[8px] ${
              isActive('/mypage/created') ? '' : 'hover:bg-[#ebebeb]'
            }`}
          >
            <Link
              to="/mypage/created"
              className={`sticky z-10 w-[100%] h-[100%] py-[8px] ${
                isActive('/mypage/created') ? 'border-b-[3px] border-black' : ''
              }`}
            >
              생성됨
            </Link>
          ...
          >
            <Link
              ...
              className={`w-[100%] h-[100%] py-[8px] ${
                isActive('/mypage') ? 'border-b-[3px] border-black' : ''
              }`}
            >
              저장됨
            </Link>
