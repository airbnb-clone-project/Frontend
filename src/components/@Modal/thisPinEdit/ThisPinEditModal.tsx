      ...
      >
        ...
        <div className="flex px-4 justify-between max-md:flex-col-reverse">
          <div className="flex flex-col flex-1">
            ...
            {/* 보드 섹션 select 컴포넌트 */}
            <SectionSelector
              boardSectionSelectModalClose={boardSectionSelectModalClose}
              boardSectionSelectModalOpen={boardSectionSelectModalOpen}
              currentSection={currentSection}
              isBoardSectionSelectModal={isBoardSectionSelectModal}
        ...
        <div className="flex p-6 justify-between">
          ...
          <div className="flex gap-2">
            <Button text="취소" color="gray" onClick={cancelBtnOnClick} />
