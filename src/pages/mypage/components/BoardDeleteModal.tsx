...
const BoardDeleteModal = () => {
    ...
    return (
        <div className="w-[90vw] max-w-[540px]">
            {/* Modal header 영역 */}
            ...
            <div className="p-6">
                <p>
                    <span className="font-semibold">동물</span> 보드와 핀 18개가
                    프로필에서 삭제됩니다. 7일이 지나면
                    <span className="font-semibold">최근에 삭제됨</span>{' '}
                    섹션에서 프로필을 복원할 수 없습니다. 이후에는 영구적으로
                    삭제됩니다.
                </p>
            </div>
