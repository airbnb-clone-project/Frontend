...
const FilterModal = ({
    ...
    return (
        <div
            ...
            className="z-50 rounded-[16px] border-[1px] w-[200px] absolute bottom-[-8px] left-1/2 transform -translate-x-1/2 translate-y-full px-[8px] py-[8px] text-[12px] text-[#111111] bg-white rounded shadow-lg"
        >
            <div>
                ...
                <p
                    ...
                    className={`hover:bg-[#e9e9e9] flex justify-between items-center cursor-pointer rounded-[8px] font-semibold text-[16px] px-[8px] py-[8px] ${
                        currentFilter === '사용자 지정' ? 'bg-[#e9e9e9]' : ''
                    }`}
                >
                    <span>사용자 지정</span>
                ...
                <p
                    onClick={() => filterItemOnClick('마지막으로 추가한 핀')}
            ...
            <div className="mt-[16px]">
                <p className="font-nomal px-[8px] py-[8px]">프로필 레이아웃</p>
